...
void sparse_solve(void* out_ptr, void** data_ptr) {
  ...
  static Eigen::SparseQR<Eigen::SparseMatrix<T>, Eigen::COLAMDOrdering<int>> forwardsolver;
  static Eigen::SparseQR<Eigen::SparseMatrix<T>, Eigen::COLAMDOrdering<int>> backwardsolver;
...
PYBIND11_MODULE(custom_call_sparse_solve_qr, m) { 
