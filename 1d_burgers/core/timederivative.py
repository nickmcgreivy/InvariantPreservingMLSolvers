...
from model import (
    stencil_delta_flux_FV_1D_burgers,
    stencil_flux_FV_1D_burgers,
    stencil_flux_FV_1D_burgers_diffusion,
)
...
def _flux_term_FV_1D_burgers(
    ...
    if core_params.flux == Flux.GODUNOV:
        ...
        if delta:
            ...
            flux_right = stencil_flux_FV_1D_burgers_diffusion(
                a, core_params, model, params
            )
    else:
        raise NotImplementedError
