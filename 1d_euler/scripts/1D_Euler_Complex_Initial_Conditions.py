...
Tf = 0.2
BC = 'ghost'
sim_id = "euler_{}_complex".format(BC)
train_id = "euler_{}_complex".format(BC)
DEPTH=4
...
kwargs_init = {'min_num_modes': 0, 'max_num_modes': 4, 'min_k': 0, 'max_k': 3, 'amplitude_max': 1.0, 'background_rho' : 1.0, 'min_rho' : 0.75, 'background_p' : 1.0, 'min_p' : 0.5}
...
with open('mses_complex.npy', 'wb') as f:
    onp.save(f, errors)
...
mses = onp.load('mses_complex.npy')
