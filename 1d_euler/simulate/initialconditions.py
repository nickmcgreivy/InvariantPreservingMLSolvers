...
def f_init_sum_of_amplitudes(core_params, key, min_num_modes=1, max_num_modes=6, min_k=0, max_k=3, amplitude_max=1.0, background_rho = 1.0, min_rho=0.5, background_p = 1.0, min_p=0.01):
	"""
